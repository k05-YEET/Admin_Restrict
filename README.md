...
File: change_sudoers_2604_06-2026.sh - Zuletzt getestet auf Ubuntu 26.04 LTS im Juni 2026

Bei Bedarf kann man den Username "cpsadmin" einfach austauschen um einen anderen User alles direkt zu erlauben.  

# Installing  
curl -LO https://github.com/k05-YEET/Admin_Restrict/raw/refs/heads/ubuntu_2604_lts/change_sudoers_2604_06-2026.sh && chmod +x change_sudoers_2604_06-2026.sh  
# Executing  
sudo ./change_sudoers_2604_06-2026.sh  

# Troubleshooting  
Falls dieser Error kommt: "bash: ./change_sudoers_2604_06-2026.sh: /bin/bash^M: bad interpreter: No such file or directory"  
aber die Syntax korrekt ist dann folgendes ausführen (Skript = auf windows geschrieben): sed -i 's/\r$//' change_sudoers_2604_06-2026.sh  
